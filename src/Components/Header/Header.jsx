...
const Header=()=>{
    ...
    return(
            ...
            alignItems={'center'}>
                ...
                ><Heading as='h1' fontSize={{base:'12',sm:'16',md:'36'}} textColor={'white'}><Link _hover={{color:'rgba(253, 240, 123, 0.986)', textDecoration:'none'}}><FontAwesomeIcon icon={faScrewdriverWrench} spin /> MaderaStore.com </Link></Heading></Box>
