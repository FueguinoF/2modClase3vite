...
const Main=()=>{
    ...
    return(	
            ...
            justifyContent={"space-around"} bgImg="linear-gradient(rgba(55, 179, 44, 0.6), rgba(55, 179, 44, 0), rgba(55, 179, 44, 0.6)), url('https://images.rawpixel.com/image_800/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDIyLTA1L3B4NTkzNzEzLWltYWdlLWt3dnhvZXB2LmpwZw.jpg')"  > 
